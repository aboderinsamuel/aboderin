...
const PROJECTS = [
  {
    ...
    image: belly,
    impact: "Processed 10,000+ orders in first 6 months. Reduced downtime to <0.1%.",
  ...
  },
  {
    ...
    link: "",
    image: dragImg,
    impact: "Reduced data latency by 85%. Used by 3+ enterprise clients.",
    badges: ["Enterprise"],
  },
  {
    ...
    link: "",
    image: gdscImg,
    impact: "Automated 90% of manual inventory tasks. Enabled real-time analytics.",
    badges: ["Automation"],
  },
  {
  ...
  },
  {
    ...
    impact: "Achieved 95% accuracy. 20+ contributors. Used in 2 university courses.",
  ...
  // Example of a high-profile open source project
  {
    ...
    technologies: ["React", "TypeScript", "Node.js", "Elasticsearch", "Tailwind CSS"],
    category: "Libraries / Packages / Modules / Applications / Frameworks",
    image: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=400&q=80",
    badges: ["Planned", "Spiritual"],
    impact: "Launching soon. Designed to empower spiritual growth through curated audio content.",
  },
];
...
export function Projects() {
  ...
  return (
    <main className="max-w-4xl mx-auto px-2 sm:px-4 py-6 sm:py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-8 pt-0">
