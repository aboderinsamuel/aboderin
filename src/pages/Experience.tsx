...
import westhillLogo from "../assets/Westhill_L.jpg";
...
export function Experience() {
  ...
  const experiences = [
    ...
    {
      company: "Westhill Community Support",
      role: "Full-Stack / Platform Developer (Volunteer)",
      period: "Jun 2025 – Present | 🇨🇦 Remote (Volunteer)",
      description:
        "Implemented a modern Next.js/React frontend with accessibility-first design (WCAG focus), optimized performance (95+ Lighthouse), and integrated content workflows. Built deployment + monitoring pipeline and improved community engagement via structured information architecture.",
      logo: westhillLogo,
    },
    {
      company: "Coach John",
